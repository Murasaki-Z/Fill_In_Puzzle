...
combinationCheck(_, [], Matches, Matches).
combinationCheck(Square, Words, Matches, Total) :-
    Words = [Word|Others],
	(	canJoin(Word, Square)
	->	combinationCheck(Square, Others, Matches+1, Total)
	;	combinationCheck(Square, Others, Matches, Total)
	).
